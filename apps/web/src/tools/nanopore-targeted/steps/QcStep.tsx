...
export function QcStep() {
  ...
  return <div className="space-y-6">
    ...
    <Card><CardHeader><CardTitle>Read-preserving QC model</CardTitle></CardHeader><CardContent className="space-y-2 text-sm">
      ...
      <p>7. Every amino-acid state—including the reference state—gets its own RPM fold enrichment versus Round 0. Statistics reuse the NGS helpers: pseudocount 1, two-count Poisson delta variance, two-sided p and per-target BH-FDR.</p>
    </CardContent></Card>
